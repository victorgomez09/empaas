...
import BuildSuccessEmail from "@empaas/server/emails/emails/build-success";
...
export const sendBuildSuccessNotifications = async ({
	...
	for (const notification of notificationList) {
		...
		if (email) {
			...
			await sendEmailNotification(email, "Build success for empaas", template);
		}
		...
		if (discord) {
			...
			await sendDiscordNotification(discord, {
				...
				footer: {
					text: "Empaas Build Notification",
				},
			});
		}
