import type { findProjectById } from "@empaas/server";
...
const EnvironmentPage = (
	...
	return (
		<div>
			...
			<Head>
				<title>
					Environment: {currentEnvironment.name} | {projectData?.name} | Empaas
				</title>
			</Head>
			...
			<Card className="w-full h-full !bg-transparent">
				...
				<CardContent className="space-y-2 py-8 border-t gap-4 flex flex-col min-h-[60vh] h-full">
					<>
						<div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
							...
							<div className="flex flex-col gap-2 lg:flex-row lg:gap-4 lg:items-center h-full">
									...
									<div className="gap-5 pb-10 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3">
										{filteredServices?.map((service) => (
											<Card
												...
												className="flex flex-col group relative cursor-pointer transition-colors hover:ring-1 hover:ring-primary"
											>
												{service.serverId && (
