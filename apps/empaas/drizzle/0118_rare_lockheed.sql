...
ALTER TYPE "public"."serviceType" ADD VALUE 'libsql' BEFORE 'mysql';--> statement-breakpoint
CREATE TABLE "libsql" (
...
ALTER TABLE "member" ADD COLUMN "canDeleteEnvironments" boolean DEFAULT false NOT NULL;--> statement-breakpoint
