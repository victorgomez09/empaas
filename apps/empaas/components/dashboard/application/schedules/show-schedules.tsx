...
interface Props {
	id: string;
	scheduleType?: "application" | "compose" | "server" | "empaas-server";
}
						...
						{schedules.map((schedule) => {
							...
							return (
								<div
									...
									className="flex items-center flex-wrap sm:flex-nowrap gap-y-2 justify-between rounded-lg p-3 transition-colors bg-card"
								>
										...
										<div className="space-y-1.5">
											...
											<div className="flex items-center gap-2 text-sm text-muted-foreground flex-wrap">
												...
												{schedule.scheduleType !== "server" &&
													schedule.scheduleType !== "empaas-server" && (
														<>
