			...
			<DialogContent className="sm:max-w-7xl min-h-[75vh]">
				...
				<DialogHeader>
					<DialogTitle className="text-2xl text-center">
						Welcome To Empaas Cloud 🎉
					</DialogTitle>
					<DialogDescription className="text-center max-w-xl mx-auto">
						Thank you for choosing Empaas Cloud! 🚀 We're excited to have you
								...
								<div className="flex flex-col gap-2 border p-4 rounded-lg">
									...
									<div>
										...
										<ul className="list-inside list-disc pl-4 text-sm text-muted-foreground mt-4">
											...
											<li>
												<a
													href=" https://app.americancloud.com/register?ref=empaas"
													className="text-link underline"
												>
								...
								return (
									<div className="flex flex-col gap-6">
										<div className="flex flex-col gap-2">
											...
											<p className="text-muted-foreground">
												Here are some of the things you can do with Empaas
												Cloud:
											</p>
										</div>
										...
										<div className="flex flex-col gap-2 mt-4">
											...
											<div className="flex flex-row gap-4">
												...
												<Button className="rounded-full  w-fit">
													<Link
														href="https://github.com/esmosolutions/empaas"
														aria-label="Empaas on GitHub"
														target="_blank"
												...
												>
													<Link
														href="https://docs.empaas.com/docs/core"
														aria-label="Empaas Docs"
														target="_blank"
														className="flex flex-row items-center gap-2 "
													>
														<BookIcon size={16} />
