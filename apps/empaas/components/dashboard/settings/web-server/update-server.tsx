import type { IUpdateData } from "@empaas/server/index";
import {
	Bug,
	Download,
	Info,
				...
				{!hasCheckedUpdate && (
					<div className="mb-8">
						<p className="text text-muted-foreground">
							Check for new releases and update Empaas.
							<br />
							<br />
					...
					<div className="rounded-lg bg-[#16254D] p-4 mb-8">
						<div className="flex gap-2">
							...
							<div className="text-[#5B9DFF]">
								...
								<Link
									href="https://github.com/esmosolutions/empaas/releases"
									target="_blank"
