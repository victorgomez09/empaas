...
const TEMPLATE_BASE_URL_KEY = "empaas_template_base_url";
							...
							>
								{templates?.map((template, idx) => (
									<div
										...
										className={cn(
											"flex flex-col rounded-lg overflow-hidden relative bg-card",
									...
									>
										...
										>
											<img
												src={`${customBaseUrl || "https://templates.empaas.com/"}/blueprints/${template?.id}/${template?.logo}`}
												className={cn(
													"object-contain",
